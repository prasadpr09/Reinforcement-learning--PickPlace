...
"""
Defines task specification objects, which are used to store taREMOVED_SECRET_KEYspecific settings
for data generation.
"""
import json
...
class MG_TaskSpec:
    """
    Stores taREMOVED_SECRET_KEYspecific settings for data generation. Each task is a sequence of
